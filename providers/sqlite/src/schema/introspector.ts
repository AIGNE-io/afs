...
export class SchemaIntrospector {
   ...
   */
  async introspectTable(db: SqliteDatabase, tableName: string): Promise<TableSchema> {
   ...
   */
  async hasFTS(db: SqliteDatabase, tableName: string): Promise<boolean> {
   ...
   */
  async rebuildFTS(db: SqliteDatabase, tableName: string): Promise<void> {
    const ftsTableName = `${tableName}_fts`;
