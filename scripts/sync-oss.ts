...
const OSS_TEMPLATE_FILES = ["README.md", "LICENSE", "CONTRIBUTING.md", "SECURITY.md", "examples"];
...
$1`,
  ...
  content = content.replace(
    /    \/\/ ── Explorer events ──\n    const explorerMapping = resolveExplorerExec\(exec, args\);\n    if \(explorerMapping\) \{[\s\S]*?\n    \}\n\n    \/\/ ── Mount configuration form/,
