/**
 * Data seed mechanism — copies initial data from /blocklet/seed/ to /data/
...
const SEED_DIR = "/blocklet/seed";
const DATA_DIR = "/data";

/**
 * Seed initial data from `/blocklet/seed/` to `/data/`.
