/**
 * Route seed mechanism — copies initial routes from /program/.route/ to /data/.route/
...
const PROGRAM_ROUTE_DIR = "/program/.route";
const DATA_ROUTE_DIR = "/data/.route";

/**
 * Seed routes from `/program/.route/` to `/data/.route/` if the data directory is empty.
 *
